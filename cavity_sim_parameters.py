...
class cavity_sim_parameters:
    ...
    rib_cavity_params = {
        # unit cell dimensions
        "a": 2.659218106995883e-07, #lattice constant 
        "hx": 1e-7,
        "hy": 4e-07,
        "thickness": 500e-9,
        "beam_width": 5.050493279419303e-07,
        ...
        "WN": 3, # the number of unit cells in the waveguide region 
        "WG_hole_tapering_prefactor": 0.437, # For the waveguide region: the prefactor that defines the minimum hole dimensions we are tapering to
        "C_lattice_tapering_prefactor": 0.8, # For the cavity region: the prefactor that defines the minimum lattice constant in the cavity region 
        "WG_lattice_tapering_prefactor": 0.8, # For the waveguide region: the prefactor that defines the minimum lattice constant in the waveguide region 
        "cavity_length": 20e-6, # the length of the device (most be larger than the simulation size)

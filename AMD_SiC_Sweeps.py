...
def fitness(params):
	...
	target_frequency = 234.212857812500e12
	...
	cell_box = BoxStructure(Vec3(0), Vec3(a,w0,h0), DielectricMaterial(3.5284, order=2, color="red"))
	...
	taper_cells_R = []
	while i < TN: 
		taper_box_L = BoxStructure(Vec3(0), Vec3(a-(i*a_tr),w0,h0), DielectricMaterial(3.5284, order=2, color="red"))
		...
		taper_box_R = BoxStructure(Vec3(0), Vec3(amin+(i*a_tr),w0,h0), DielectricMaterial(3.5284, order=2, color="red"))
	...
	cavity = Cavity1D(
      ...
      structures=[ BoxStructure(Vec3(0), Vec3(l, w0, h0), DielectricMaterial(3.5284, order=2, color="red")) ],
      engine=engine
    )
...
p0 = [3.20e-07, 6.56e-01, 1.75e+00, 7.00e-01]

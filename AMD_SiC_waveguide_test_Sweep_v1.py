...
def runSim(params):
    ...
    man_mesh = MeshRegion(BBox(Vec3(0),Vec3(5e-6,0.75e-6,0.625e-6)), 15e-9, dy=None, dz=None)
    ...
    with open("./sim_data/OptimizeListFull_with_waveguide_test_sweep_t2.csv","a") as file_csv:

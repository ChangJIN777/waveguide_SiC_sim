...
target_frequencies = np.linspace(300e12,400e12,5)
...
for a in a_list:
    for w in w_list:
        for target_frequency in target_frequencies:
            sim_ellipticalCavity_coarse_v2(a,hx,hx_min,hy,hy_min,t,t_wvg,target_frequency,file_name,MN_L,MN_R,TN,w0=w)

...
file_name = "OptimizeListFull_Overcoupled_cavity_500nm_testRun_1.csv"
...
# a_list = np.linspace(200e-09,300e-09,10)
# w_list = np.linspace(400e-09,800e-09,5)
# hx_min = d_min*hx
# hy_min = d_min*hy
# for target_frequency in target_frequencies:
#     for a in a_list:
#         for w in w_list:
#             sim_ellipticalCavity_v2(a,hx,hx_min,hy,hy_min,t,t_wvg,target_frequency,file_name,MN_L,MN_R,TN,w0=w)
